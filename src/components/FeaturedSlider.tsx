...
export default function FeaturedSlider({ ads }: { ads: Ad[] }) {
  ...
  return (
    <div className="relative">
      ...
      <div className="mb-3 flex items-center gap-2 px-1">
        <span className="flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 to-amber-600 text-white shadow-sm">
          <HiStar size={16} />
        </span>
        <h2 className="text-lg font-extrabold text-gray-900">آگهی‌های ویژه</h2>
      </div>
              ...
              <Link href={`/property/${p.id}`} className="group block">
                <article
                  className="
                    ...
                    bg-white
                    h-[310px]
                    shadow-[0_0_0_3px_rgba(251,191,36,0.15)]
